...
const TABS = [
  ...
  { id: "info",       label: "Practical Information" },
    ...
    <div className="font-sans bg-white min-h-screen">
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-navy text-3xl font-bold mb-4 tracking-tight">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        {activeTab === "programme" && (
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-[10px] font-semibold uppercase tracking-[0.38em] text-gold">Programme</span>
            </div>
            {translation?.agenda ? (
              <div
              ...
              <div
                className="rounded-2xl p-10 text-center border border-gray-100"
              ...
              >
                ...
                <h3 className="text-navy font-bold text-base mb-2">Programme Coming Soon</h3>
                <p className="text-gray-500 text-sm leading-relaxed max-w-md mx-auto">
                  The detailed programme will be published closer to the event date.
                  Check back or visit the official PABSEC website for updates.
                </p>
                <a
                  href="https://pabsec.org"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 mt-6 text-sm font-semibold transition-colors hover:text-gold"
                  style={{ color: "#1A5FA8" }}
                >
                  Visit pabsec.org
            ...
            {translation?.description && (
              <div className="mt-10">
                <h2 className="text-navy font-bold text-lg mb-4">About this Assembly</h2>
        ...
        {activeTab === "documents" && (
          <div>
            <div className="flex items-center gap-3 mb-8">
              <div className="h-px w-8 bg-gold" />
              <span className="text-[10px] font-semibold uppercase tracking-[0.38em] text-gold">Documents</span>
            </div>
            <div
              className="rounded-2xl p-10 text-center border border-gray-100"
              style={{ background: "rgba(11,30,61,0.02)" }}
            >
              ...
              <h3 className="text-navy font-bold text-base mb-2">Official Documents</h3>
              <p className="text-gray-500 text-sm leading-relaxed max-w-md mx-auto">
                Resolutions, reports and session documents are published on the official PABSEC website.
                Draft documents for delegates will be made available prior to the session.
              </p>
              <a
        ...
        {activeTab === "info" && (
          <div>
            <div className="flex items-center gap-3 mb-8">
              <div className="h-px w-8 bg-gold" />
              <span className="text-[10px] font-semibold uppercase tracking-[0.38em] text-gold">Practical Information</span>
            </div>
              ...
              {[
                {
                  ...
                  title: "Venue",
                  body: `The ${translation?.title ?? "General Assembly"} will be held in ${event.location}. Full venue details will be shared with registered delegates.`,
                },
                {
                  icon: (
                    <path strokeLinecap="round" strokeLinejoin="round"
                  ...
                  body: "Visa requirements depend on your nationality. PABSEC Secretariat can provide invitation letters upon request to support visa applications.",
                },
                {
                  icon: (
                    <path strokeLinecap="round" strokeLinejoin="round"
                  ...
                  title: "Accommodation",
                  body: "A list of recommended hotels near the venue will be shared with registered delegates. Early booking is advised as availability may be limited.",
                },
                {
                  icon: (
                    <path strokeLinecap="round" strokeLinejoin="round"
                  ...
                  body: "For queries regarding practical arrangements, please contact the PABSEC Secretariat directly via the Contact page.",
                },
              ].map((card) => (
                <div
                  key={card.title}
            ...
            <p className="text-gray-400 text-xs mt-8 text-center">
              Full practical information will be distributed to registered delegates ahead of the session.
            </p>
          </div>
        )}
          ...
          <div>
            ...
            {isUpcoming ? (
              <div className="max-w-2xl">
                <h2 className="text-navy font-bold text-xl mb-2">Register for this Assembly</h2>
                <p className="text-gray-500 text-sm leading-relaxed mb-8">
                  Complete the form below to register as a delegate, observer or accredited participant.
                  You will receive a confirmation by e-mail after submission.
                </p>
              ...
              <div
                ...
                style={{ background: "rgba(11,30,61,0.02)" }}
              >
                <h3 className="text-navy font-bold text-base mb-2">Registration Closed</h3>
                <p className="text-gray-500 text-sm leading-relaxed max-w-md mx-auto">
                  This assembly has concluded. Registration is no longer available.
                </p>
              </div>
            )}
          </div>
