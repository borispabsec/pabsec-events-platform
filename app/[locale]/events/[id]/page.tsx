  ...
  const practicalCards = [
    {
      ...
      body: tPage("venue_body").replace("{title}", title).replace("{location}", event.location),
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        {activeTab === "programme" && (
          <div>
            ...
            {translation?.agenda ? (
              <div className="rounded-2xl p-8 border border-gray-100" style={{ boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
              ...
              <div className="rounded-2xl p-10 text-center border border-gray-100" style={{ background: "rgba(11,30,61,0.02)" }}>
                ...
                <h3 className="text-navy font-bold text-base mb-2">{tPage("programme_coming_title")}</h3>
                <p className="text-gray-500 text-sm leading-relaxed max-w-md mx-auto">{tPage("programme_coming_desc")}</p>
                <a href="https://pabsec.org" target="_blank" rel="noopener noreferrer"
        ...
        {activeTab === "documents" && (
          <div>
            ...
            <div className="rounded-2xl p-10 text-center border border-gray-100" style={{ background: "rgba(11,30,61,0.02)" }}>
              ...
              <p className="text-gray-500 text-sm leading-relaxed max-w-md mx-auto">{tPage("documents_desc")}</p>
