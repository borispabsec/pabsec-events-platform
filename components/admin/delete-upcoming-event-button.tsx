...
import { deleteUpcomingEvent } from "@/lib/admin/upcoming-event-actions";
...
export function DeleteUpcomingEventButton({ upcomingEventId, title }: Props) {
  return (
    <form
    ...
    >
      <input type="hidden" name="upcomingEventId" value={upcomingEventId} />
      <button
        type="submit"
